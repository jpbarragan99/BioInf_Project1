...
- The data set will be the one used in part 2
""")
...
def download_dataset():
    ...
    df = pd.read_csv(
        "https://github.com/jpbarragan99/BioInf_Project1/raw/main/data/06_bioactivity_data_3class_pIC50_pubchem_fp.csv", sep="\t"
    ).dropna()
    return df
